...
<body>  
        <div class="container">
            ...
            <h3 class="my-3">Supervisor Dashboard</h3>
            <!-- Period Selection Form -->
            <div class="card mb-3">
                <div class="card-body">
                    <form method="get" action="supervisor_dashboard.php" class="">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="supervisor_dashboard.php?month=<?= date('n');?>&year=<?= date('Y');?>" class="btn btn-outline-secondary btn-sm ms-2">Current Month</a>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <?php if ($employees->rowCount() > 0): ?>
                                <?php while ($row = $employees->fetch(PDO::FETCH_ASSOC)): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['self_score']); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if(empty($row['supervisor_score'])):?>
